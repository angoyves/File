...
class MinmapDB2 extends mysqli {
	...
	// FONCTION GLOBAL
	public function get_commission_id_by_sigle($comissionSigle)
	{
		$domain = $this->query("SELECT commission_id
		FROM commissions 
		WHERE commission_sigle LIKE '%".$comissionSigle."%'");
    ...
    function format_date_for_sql($date) {
		...
		/*function insert_4_chmp_into_table($table, $chmp1, $chmp2, $chmp3, $chmp4, $value1, $value2, $value3, $value4) {
        $this->query("INSERT INTO ". $table ." (". $chmp1 .", ". $chmp2 .", ". $chmp3 .", ". $chmp4 .") VALUES (" . $value1 . ", '" . $value2 . "', '" . $value3 . "', " . $value4 . ")");
    }*/
	/*function insert_4_chmp_into_table($value1, $value2, $value3, $value4) {
        $this->query("INSERT INTO listing_action_agescom (UserId, PageLink, ModificationType, DateCreation)" .
                " VALUES (" . $value1 . ", " . $value2 . ", " . $value3 . ", " . $this->format_date_for_sql($value4) . ")");
    }*/
	function insert_4_chmp_into_table($table, $chmp1, $chmp2, $chmp3, $chmp4, $value1, $value2, $value3, $value4) {
    $this->query("INSERT INTO ". $table ."(". $chmp1 .", ". $chmp2 .", ". $chmp3 .", ". $chmp4 .")" .
