...
class fichier_db82 extends mysqli {
	...
	public function getCommissionLibById($table, $champValue, $champId, $valueId) {
        $domain = $this->query("SELECT ".$champValue." FROM ".$table." WHERE ".$champId." = " 
							   . $valueId  );
	...
	public function GetMenuByObjId($ProgramId, $ObjId) {
        $domain = $this->query("SELECT MenuLibFr FROM Menus WHERE ProgramId = '"
