...
if (isset($_POST['answer'])) {
  ...
  $MM_redirectLoginSuccess = "../user/logIn.php";
  ...
  <ul>
    <table border="0" align="center">
      <tr>
        ...
        <td width="339" scope="col"><h1><a id="logo" href="http://localhost:8080/AGesCom/file/user/logIn.php">Retour à la boite de connexion</h1></td>
      </tr>
    </table>
  </ul>
