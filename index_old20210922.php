...
<div class="top"><img src="images/admin_top_agescom.jpg" alt="top"></div>
  <div id="con_wrap">
    <div class="menu">
      <ul>
        <li class="depth1_on">
          <p class="sline">Gestion d'Utilisateur</p>
          <ul>
        ...
        <li class="depth1_none">
          ...
          <ul>
            <li class="depth2_on">
              <p class="bullet"><a href="../membres/membre.php">Liste Membres</a></p>
            </li>
              ...
              <div class="dataArea">	
	                	<table class="data">
	                	    ...
	                	    <td><select name="jumpMenu" id="jumpMenu" onChange="MM_jumpMenu('parent',this,0)">
	                	      <option value="repcim.php" <?php if (!(strcmp("", $_GET['value']))) {echo "selected=\"selected\"";} ?>>All...</option>
