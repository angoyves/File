					...
					<div class="dataArea">
                        ...
                        <input type="hidden" name="MM_insert" value="frm_pubPm_insert" />
							<table class="data">
								...
								<tbody>
<tr valign="baseline">
                                                <th align="left" scope="row">Type Commission:</th>
                      <td class="style1"><select name="type_commission" class="style1" onChange="MM_jumpMenu('parent',this,0)">
                        ...
                        do {  
                        ?>
                          <option value="<?php echo "test.php?typID=".$row_rsTypeCommission['type_commission_id']?>"<?php if (!(strcmp($row_rsTypeCommission['type_commission_id'], $_GET['typID']))) {echo "selected=\"selected\"";} ?>><?php echo strtoupper($row_rsTypeCommission['type_commission_lib']) ?></option>
                                                  <?php
                                              ...
                                              <tr valign="baseline">
                                               <th align="left" scope="row">Region:</th>
                                                <td valign="middle" class="style5"><select name="menu1" class="style1" onChange="MM_jumpMenu('parent',this,0)">
                                                  <option value="test.php" <?php if (!(strcmp("test.php", $_GET['regID']))) {echo "selected=\"selected\"";} ?>>Select...</option>
                                                  <?php
                                do {  
                                ?>
                                                  <option value="<?php echo "test.php?typID=".$_GET['typID']."&regID=".$row_rsRegion['region_id']?>"<?php if (!(strcmp($row_rsRegion['region_id'], $_GET['regID']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsRegion['region_lib']?></option>
                                                  <?php
                                    ...
                                    if ($regionIsEmpty) { ?>
                                              ...
                                              <tr>
                                                ...
                                                <td valign="middle" class="style5"><select name="menu2" class="style1" onChange="MM_jumpMenu('parent',this,0)">
                                                  <option value="test.php" <?php if (!(strcmp("test.php", "depID"))) {echo "selected=\"selected\"";} ?>>Select::</option>
                                                  <?php do {  ?>
                                                  <option value="<?php echo "test.php?typID=".$_GET['typID']."&regID=".$_REQUEST['regID']."&depID=".$row_rsDepartements['departement_id']?>"<?php if (!(strcmp($row_rsDepartements['departement_id'], $_REQUEST["depID"]))) {echo "selected=\"selected\"";} ?>><?php echo strtoupper($row_rsDepartements['departement_lib']) ?> </option>
                                                  <?php
                                    ...
                                    if ($departementIsEmpty) { ?>
                                              ...
                                              <tr>
                                                ...
                                                <td valign="middle" class="style5"><select name="localite_id" class="style1" onChange="MM_jumpMenu('parent',this,0)">
                                                  <option value="test.php" <?php if (!(strcmp("test.php", $_GET['locID']))) {echo "selected=\"selected\"";} ?>>Select...</option>
                                                  <?php do {  ?>
                                                  <option value="<?php echo "test.php?typID=".$_GET['typID']."&regID=".$_REQUEST["regID"]."&depID=".$_REQUEST["depID"]."&locID=".$row_rsLocalites['localite_id']?>"<?php if (!(strcmp($row_rsLocalites['localite_id'], $_GET['locID']))) {echo "selected=\"selected\"";} ?>><?php echo strtoupper($row_rsLocalites['localite_lib']) ?></option>
                                                  <?php
                                ...
                                ?>
                                  ...
                                  ?>
                                    ...
                                    if ($localiteIsEmpty) { ?>
                                              ...
                                              <?php } ?>
                                              <tr valign="baseline">
                                                <th align="left" scope="row">Nature Commission:</th>
									...
									<tr>
										...
										<td>
										  <input type="text" class="text" id="instCd" style="width: 20%" name="instCd" readonly="readonly">
											...
											<span class="btnTy3"><input type="button" class="btn" value="Rechercher" onclick="javascript:fn_searchSupplier();"></span>
										</td>
									</tr>
									<tr align="left">
