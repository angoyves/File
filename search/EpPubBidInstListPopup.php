...
<title><?php echo MyDB::getInstance()->GetMenuByObjId($ProgramID = 'EpPubBidInstListPopup', $ObjId = 'Title'); ?></title>
...
function fn_selectListPageBidInst(){
	...
	form.action = "EpPubBidInstListFramePopup.php"; // pointe vers la page detail
...
<div id="popup_main">
	<div id="popWrap">
	    ...
	    <div id="pop_header" class="popHeader">
	        <h1 class="title"><?php echo MyDB::getInstance()->GetMenuByObjId($ProgramID = 'EpPubBidInstListPopup', $ObjId = 'Title'); ?></h1><!-- 공고기관 조회 -->
	       ...
	       <div class="tableTy2">
		       <div class="dataArea">
		            ...
		            <table class="data">
	                    ...
	                    <tbody>
	                    	<tr>
	                        	<th scope="row">Matricule :</th><!-- 공고기관코드 -->
	                            <td>
