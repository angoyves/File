...
<div id="popWrap">
  ...
  <table class="data">
    ...
    <tbody>
      <?php do { ?>
  <tr>
    <td nowrap><?php if (isset($row_rsMembresCommission['sexe']) && $row_rsMembresCommission['sexe']=="M") { ?>
    ...
    <?php } else { ?>
        ...
        <?php } ?>
    <?php } ?>
    &nbsp;<?php echo strtoupper($row_rsMembresCommission['personne_nom']) .' '. strtoupper($row_rsMembresCommission['personne_prenom']); ?></td>
    <td><?php echo $row_rsMembresCommission['fonction_lib']; ?></td>
    <td>
      <?php if (isset($row_rsMembresCommission['state']) && $row_rsMembresCommission['state']=="A") { ?>
      En activité
      <?php } else { ?>
      En cessation d'activité depuis le <?php echo date_fr2($row_rsMembresCommission['date_cessation']); ?>
      <?php } ?>&nbsp;</td>
