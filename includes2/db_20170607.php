...
// FIN COMMISSIONS
    ...
    public function get_nombre_jour_by_values($commission_id, $personne_id, $month, $year, $etat_valid) {
		$year = $this->real_escape_string($year);
		//$month = $this->real_escape_string($month);
        $domain = $this->query("SELECT nombre_jour FROM sessions WHERE sessions.membres_personnes_personne_id = " . $personne_id 
							   ...
							   . "' AND etat_validation = '" . $etat_valid 
							   . "' AND etat_appur = 0 ");
	    ...
	    public function get_nombre_jour_sCom_by_values($commission_id, $personne_id, $month, $year, $etat_valid) {
		$year = $this->real_escape_string($year);
		//$month = $this->real_escape_string($month);
