  ...
  <form class="wufoo" action="<?php echo $loginFormAction .'?uID=' . $userID; ?>" method="POST" name="form1" id="form1">
    <ul>
      ...
      <li class="section">
        ...
        <div>Créer votre compte en cliquant sur le lien suivant...<a href="#"><img src="../images/register_btn.png" alt="user register" onClick="javascript:fn_userRegist();"></a></div>
      </li>
    </ul>
  </form>
</div>
