...
--%>
<?php 
<?php echo ${contextPath}; ?> = $_SERVER["DOCUMENT_ROOT"];
?>
...
<script type="text/javascript" src="<?php echo ${contextPath}; ?>js/common/font.js"></script>
<script type="text/javascript" src="<?php echo ${contextPath}; ?>js/common/alert.js"></script>
<script type="text/javascript" src="<?php echo ${contextPath}; ?>js/common/alertExms.js"></script>
<script type="text/javascript" src="<?php echo ${contextPath}; ?>js/common/validation.js" ></script>
<script type="text/javascript" src="<?php echo ${contextPath}; ?>js/common/frame.js" ></script>
<script type="text/javascript" src="<?php echo ${contextPath}; ?>js/common/ajax.js" ></script>
<script type="text/javascript" src="<?php echo ${contextPath}; ?>js/common/string.js" ></script>
<script type="text/javascript" src="<?php echo ${contextPath}; ?>js/common/prototype.js"></script>
<script type="text/javascript" src="<?php echo ${contextPath}; ?>js/common/event.js" ></script>
<script type="text/javascript" src="<?php echo ${contextPath}; ?>js/common/pagination.js"></script>
<script type="text/javascript" src="<?php echo ${contextPath}; ?>js/common/calendar.js"></script>
<script type="text/javascript" src="<?php echo ${contextPath}; ?>js/common/date.js"></script>
