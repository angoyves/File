...
//$query_recordSet = sprintf(" %s  ORDER BY personne_nom, date_constation ASC", $query_recordSetBasic);
}
...
<!-- <div class="content"> -->
  ...
  <table class="data rowEven">
		        ...
		        <thead>
		          <tr>
		            <th scope="col"><?php echo MyDB::getInstance()->GetMenuByObjId($ProgramID = 'rsce', $ObjId = 'rsceNum'); echo $colValue_fonction; ?></th>
		            <th scope="col"><?php echo MyDB::getInstance()->GetMenuByObjId($ProgramID = 'rsce', $ObjId = 'rsceCom'); ?></th>
		        ...
		        <tbody>
		          ...
		          <tr>
		            ...
		            <td class="tL"><?php echo strtoupper($row_recordSet['commission_sigle']); ?>&nbsp;
		              <?php 
							$result = '../'.MinmapDB::getInstance()->get_lib_by_id(fichiers, url, commissions_commission_id, $row_recordSet['commission_id']);
							if (isset($result) && $result!='../' ){
							do {
							?>
		              <a href="#" onClick="<?php popup(htmlentities($result), "710", "650"); ?>"> <img src="../images/img/b_pdfdoc.png" width="16" height="16" /> </a>
		              <?php
