...
<table class="data">
								...
								<tbody>
									<tr>
										...
										<td colspan="3"><?php echo $row_Recordset['user_name'] .' '. $row_Recordset['user_lastname']; ?></td>
									</tr>
									<tr>
										<th scope="row" class="noLine tL">Autorité</th>
										<td><?php echo $row_Recordset['userAuthNm']; ?></td>
										<th scope="row" class="noLine tL">Date et Heure de Demande de Validation</th>
										<td><?php echo $row_Recordset['regDt']; ?></td>
									</tr>
									<tr>
										<th scope="row" class="noLine tL">Service Emetteur</th>
										<td colspan="3"><?php echo $row_Recordset['supplierNm']; ?></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td colspan="3"><?php echo $row_Recordset['eMail']; ?></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><?php echo $row_Recordset['acceptId']; ?></td>
										<th scope="row" class="noLine tL">Valideur</th>
										<td><?php echo $row_Recordset['acceptNm']; ?></td>
									</tr>
								</tbody>
						  </table>
					</div>
