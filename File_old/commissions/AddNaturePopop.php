...
<script type="text/javaScript" language="javascript">
	...
	//Form Submit
	function fn_submitInsertNature(){
		var form = document.frm_nature;
		form.action = "../Ctrl/InsertNatureCtrl.php";
...
<div id="popWrap">
	...
	<div id="pop_header" class="popHeader">
		<h1 class="title">Eregistrer la nature de la Commission<?php //echo MyDB::getInstance()->GetMenuByObjId($ProgramID = 'TypeCommissionAddPopop', $ObjId = 'title'); ?></h1>
		...
		<div class="tableTy2">
		  <div class="dataArea">
				<span class="rtl"></span><span class="rtr"></span><span class="rbl"></span><span class="rbr"></span>
                  <form name="frm_nature" modelAttribute="UserSVO" method="post" id="frm_nature">
                    <!-- 입력폼 //-->
<table class="data">
                                        <colgroup>
                                            <col style="width: 25%">
                            ...
                            <tr valign="baseline">
                              <th nowrap align="right">Sigle
                              <?php //echo MyDB::getInstance()->GetMenuByObjId($ProgramID = 'UserRegPopup', $ObjId = 'userId'); ?></th>
                              <td><input type="text" name="sigleNature" id="sigleNature" value="" size="20"></td>
                            </tr>
                            <tr valign="baseline">
                              <th nowrap align="right">Libelle 
                              <?php //echo MyDB::getInstance()->GetMenuByObjId($ProgramID = 'UserRegPopup', $ObjId = 'userId'); ?></th>
                              <td><input type="text" name="libNature" id="libNature" value="" size="32"></td>
                            </tr>
                        </tbody>
                      </table>
					  ...
					  <input type="hidden" name="MM_insert" value="frm_nature">
			</form>
		  </div>
		</div>
		<!-- //입력폼 끝 -->
		...
		<div class="popFooter"><span class="btnTy4">
		  <input type="button" class="btn" value="Enregistrer<?php //echo MyDB::getInstance()->GetMenuByObjId($ProgramID = 'TypeCommissionAddPopop', $ObjId = 'insertBtn'); ?>" onClick="javascript:fn_submitInsertNature();">
