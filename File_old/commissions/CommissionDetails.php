...
if (isset($_POST['bizRegNo'])) {
  $colname_rsMembresCommission = $_POST['bizRegNo'];
}
mysql_select_db($database_MyFileConnect, $MyFileConnect);
...
<script type="text/javaScript" language="javascript">
	...
	function fn_moveList(){
		...
		form.isBack.value ="Y";
		form.target = "_top";
		form.action = "../commissions/CommissionListNew.php";
		form.submit();
	}
...
<div id="sitewrap">
	<div id="wrap">
        ...
        <div class="menu">
			...
			<div class="content" id="contents">
				<h1 class="h1_title"><?php echo MyDB::getInstance()->GetMenuByObjId($ProgramID = 'PubCommissionDetail', $ObjId='title'); ?></h1>
							...
							<table class="data">
								...
								<tbody>
                                    ...
                                    <tr>
										...
										<td><?php echo $row_Recordset['display_agescom']; ?></td>
									</tr>
								</tbody>
							</table>
						</div>
  ...
  <table class="data">
    ...
    <tbody>
      <?php do { ?>
  <tr>
    <td><img src="../images/icons/young-user-icon.jpg" width="18" height="16">&nbsp;<a href="../personnes/upd_personne_new.php?perID=<?php echo $row_rsMembresCommission['personne_id']; ?>&comID=<?php echo $row_Recordset['commission_id']; ?>"><?php echo strtoupper($row_rsMembresCommission['personne_nom']) .' '. strtoupper($row_rsMembresCommission['personne_prenom']); ?></a></td>
...
<?php if ($totalRows_Recordset1 == 0) { // Show if recordset empty ?>
  ...
  <?php } // Show if recordset empty ?>
				...
				<div class="fR pt10 mb20">
                    ...
                    <span class="btnTy21"><input type="button" class="btn" value="Ajouter un membre" onClick="javascript:fn_moveCommissionDetails('<?php echo $row_recordSet['commission_id']; ?>');"></span>
