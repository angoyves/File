...
<table align="center">
  <tr>
    <th align="right" scope="col"><a href="connexion.php">Accueil</a>&nbsp;|<a href="show_structures_membres.php">Representants par structure</a>&nbsp;|<a href="doublons.php">Afficher les doublons</a><!--|&nbsp;<a href="archives.php">Consulter les archives</a>-->&nbsp;|&nbsp;<a href="connexions.php" target="_blank">Se connecter</a></th>
  </tr>
  <tr>
    ...
    <table>
      ...
      <tr>
		...
		do {  
		?>
          <option value="<?php echo "repcipm.php?value=".$_GET['value']."&regID=".$row_rsRegion['region_id']?>"<?php if (!(strcmp($row_rsRegion['region_id'], $_GET['regID']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsRegion['region_lib']?></option>
          <?php
	  ...
	  <tr>
        ...
        <td><span class="style5">
          <select name="menu2"  onChange="MM_jumpMenu('parent',this,0)">
            ...
            <?php do {  ?>
            <option value="<?php echo "repcipm.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$row_rsDepartements['departement_id']?>"<?php if (!(strcmp($row_rsDepartements['departement_id'], $_REQUEST["depID"]))) {echo "selected=\"selected\"";} ?>><?php echo strtoupper($row_rsDepartements['departement_lib']) ?></option>
            <?php
...
<tr>
        ...
        <td>
          <select name="jumpMenu" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)">
            <option value="<?php echo "repcipm.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=" ?>" 
			<?php if (!(strcmp("", $_GET['typeM']))) {echo "selected=\"selected\"";} ?>>[Tous]</option>
            <option value="<?php echo "repcipm.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=2" ?>" 
			<?php if (!(strcmp(2, $_GET['typM']))) {echo "selected=\"selected\"";} ?>>SECRETAIRE</option>
            <option value="<?php echo "repcipm.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=1" ?>" 
			<?php if (!(strcmp(1, $_GET['typM']))) {echo "selected=\"selected\"";} ?>>PRESIDENT</option>          
            <option value="<?php echo "repcipm.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=142" ?>" 
			<?php if (!(strcmp(142, $_GET['typM']))) {echo "selected=\"selected\"";} ?>>Rep MINMAP</option>
            <option value="<?php echo "repcipm.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=144" ?>" 
			<?php if (!(strcmp(144, $_GET['typM']))) {echo "selected=\"selected\"";} ?>>Rep MINFI</option>
            <option value="<?php echo "repcipm.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=145" ?>" 
			<?php if (!(strcmp(145, $_GET['typM']))) {echo "selected=\"selected\"";} ?>>Rep MINEPAT</option>
            <option value="<?php echo "repcipm.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=143" ?>" 
			<?php if (!(strcmp(143, $_GET['typM']))) {echo "selected=\"selected\"";} ?>>Rep MINDEVEL</option>
            <option value="<?php echo "repcipm.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=146" ?>" 
			<?php if (!(strcmp(146, $_GET['typM']))) {echo "selected=\"selected\"";} ?>>Rep TUTELLE</option>
            <option value="<?php echo "repcipm.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=40"  ?>"
      ...
      <tr>
        ...
        <td><select name="jumpMenu3" id="jumpMenu3" onchange="MM_jumpMenu('parent',this,0)">
          ...
          <option value="<?php echo "repcipm.php?value=" . $_GET['value'] . "&typID=1" ?>" <?php if (!(strcmp(1, $_GET['typID']))) {echo "selected=\"selected\"";} ?>>Commission centrale</option>
          <option value="<?php echo "repcipm.php?value=" . $_GET['value'] . "&typID=7" ?>" <?php if (!(strcmp(7, $_GET['typID']))) {echo "selected=\"selected\"";} ?>>Commission Interne</option>
          <option value="<?php echo "repcipm.php?value=" . $_GET['value'] . "&typID=8" ?>" <?php if (!(strcmp(8, $_GET['typID']))) {echo "selected=\"selected\"";} ?>>Commission Speciales</option>
          <option value="<?php echo "repcipm.php?value=" . $_GET['value'] . "&typID=3" ?>" <?php if (!(strcmp(3, $_GET['typID']))) {echo "selected=\"selected\"";} ?>>Commission régionale</option>
          <option value="<?php echo "repcipm.php?value=" . $_GET['value'] . "&typID=4" ?>" <?php if (!(strcmp(4, $_GET['typID']))) {echo "selected=\"selected\"";} ?>>Commission départementale</option>
          <option value="<?php echo "repcipm.php?value=" . $_GET['value'] . "&typID=10" ?>" <?php if (!(strcmp(10, $_GET['typID']))) {echo "selected=\"selected\"";} ?>>Cadre de concertation</option>
        </select></td>
        <td>&nbsp;</td>
      </tr>
      <?php //echo $_GET['typID'] ?>
      ...
      <tr>
		...
		do {  
		?>
          <option value="<?php echo "repcipm.php?value=".$_GET['value']."&typID=".$coltypID_fonction."&regID=".$row_rsRegion['region_id']?>"<?php if (!(strcmp($row_rsRegion['region_id'], $_GET['regID']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsRegion['region_lib']?></option>
          <?php
		} while ($row_rsRegion = mysql_fetch_assoc($rsRegion));
		  $rows = mysql_num_rows($rsRegion);
		  if($rows > 0) {
      ...
      <tr>
        ...
        <td><span class="style5">
          <select name="menu2"  onChange="MM_jumpMenu('parent',this,0)">
            <option value="repcipm.php" <?php if (!(strcmp("repcipm.php", "depID"))) {echo "selected=\"selected\"";} ?>>Select::</option>
            <?php do {  ?>
            <option value="<?php echo "repcipm.php?value=".$_GET['value']."&typID=".$coltypID_fonction."&regID=".$_GET['regID']."&depID=".$row_rsDepartements['departement_id']?>"<?php if (!(strcmp($row_rsDepartements['departement_id'], $_REQUEST["depID"]))) {echo "selected=\"selected\"";} ?>><?php echo strtoupper($row_rsDepartements['departement_lib']) ?></option>
            <?php
			} while ($row_rsDepartements = mysql_fetch_assoc($rsDepartements));
			  $rows = mysql_num_rows($rsDepartements);
			  if($rows > 0) {
      ...
      <tr>
        ...
        <td><input type="submit" name="btnSearch" id="btnSearch" value="Envoyer" />
          <input type="button" name="btnSearch2" id="btnSearch2" value="Reinitialiser" onclick="window.location.href='repcipm.php'" /></td>
      </tr>
      <tr>
  ...
  <tr>
    <th align="left" scope="col">
	<h3><?php echo strtoupper(isset($colValue_fonction)?$row_recordSet['fonction_lib']:"Repertoire des Présidents et Representants MINMAP au sein des Commissions"); ?></h3></th>
  </tr>
  <tr>
