...
<div id="sitewrap">
              ...
              <ul>
                    <li class="depth1_on"><p class="sline">Gestion d'Utilisateur</p>
                                <ul>
                                    ...
                                    <li class="depth2"><a href="commissions/UsersReg.php">Utilisateurs</a></li>
                                    
                                    <li class="depth2"><a href="commissions/UserDetails.php">Mes Informations</a></li>
                                </ul>
                    </li>
                  </ul>
                </li>
                ...
                <li class="depth1_none">
                  ...
                  <ul>
                    ...
                    <li class="depth2_on"><p class="bullet"><a href="membres/membre.php">Liste Membres</a></p></li>
  ...
  <table class="data">
    ...
    <tbody>
      <?php do { ?>
  <tr>
    <td><?php echo strtoupper($row_rsMembresCommission['personne_nom']) .' '. strtoupper($row_rsMembresCommission['personne_prenom']); ?></td>
...
<?php if ($totalRows_Recordset1 == 0) { // Show if recordset empty ?>
  ...
  <?php } // Show if recordset empty ?>
				...
				<div class="fR pt10 mb20">
                    ...
                    <span class="btnTy21"><input type="button" class="btn" value="Ajouter un emembre" onClick="javascript:fn_moveList();"></span>
