  ...
  <table class="data rowEven">
		        ...
		        <tbody>
		          ...
		          <tr>
		            ...
		            <td class="tL"><a href="#" onClick="fn_moveCommissionDetails('<?php echo $row_recordSet['commission_id']; ?>');"><img src="../images/icons/young-user-icon.jpg" width="18" height="16"><?php echo strtoupper($row_recordSet['personne_nom'].' '.$row_recordSet['personne_prenom']); ?></a>&nbsp;</td>
		            <td class="tL"><?php 
						  ...
						  ?>
		              &nbsp; </td>
		            <td class="tL"><a href="#" onClick="fn_moveCommissionDetails('<?php echo $row_recordSet['commission_id']; ?>');"><?php echo strtoupper($row_recordSet['commission_sigle']); ?></a></td>
		            </tr>
