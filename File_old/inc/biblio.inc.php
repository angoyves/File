...
function combo_dateFrUpd1($date_mysql, $varNum=""){
	/*$varNum pour pouvoir avoir plusieurs occurence de cet objet dans une 
	page ou sur un formulaire, sans amalgame*/
	$selDay = get_day($date_mysql); //Recupère le jour de la BD
	$selDayLabel = ($selDay == "00")?"--":"$selDay";
	...
	$selYear = get_Year($date_mysql); //Recupère l'année de la BD
	$cmb_return  = "<table><tr>
		<td><select name=\"cmbDayUpd1\"".$varNum."><option value=\"$selDay\">$selDayLabel</option>".upd_loadDays()."</select></td>
		<td><select name=\"cmbMonthUpd1\"".$varNum."><option value=\"$selMonth\">".month_converter($selMonth)."</option>".upd_loadMonths()."</select></td>
		<td><select name=\"cmbYearUpd1\"".$varNum."><option value=\"$selYear\">$selYear</option>".upd_loadYears(1995)."</select></td>
		</tr></table>";
	return $cmb_return;
}
function combo_dateFrUpd2($date_mysql, $varNum=""){
	/*$varNum pour pouvoir avoir plusieurs occurence de cet objet dans une 
	page ou sur un formulaire, sans amalgame*/
	$selDay = get_day($date_mysql); //Recupère le jour de la BD
	$selDayLabel = ($selDay == "00")?"--":"$selDay";
	...
	$selYear = get_Year($date_mysql); //Recupère l'année de la BD
	$cmb_return  = "<table><tr>
		<td><select name=\"cmbDayUpd2\"".$varNum."><option value=\"$selDay\">$selDayLabel</option>".upd_loadDays()."</select></td>
		<td><select name=\"cmbMonthUpd2\"".$varNum."><option value=\"$selMonth\">".month_converter($selMonth)."</option>".upd_loadMonths()."</select></td>
		<td><select name=\"cmbYearUpd2\"".$varNum."><option value=\"$selYear\">$selYear</option>".upd_loadYears(1995)."</select></td>
		</tr></table>";
	return $cmb_return;
}
