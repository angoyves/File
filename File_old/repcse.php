...
<title><?php echo MyDB::getInstance()->GetMenuByObjId($ProgramID = 'repCcse', $ObjId = 'title'); ?></title>
...
function fn_selectListPageEpPub(){
 ...
 // 상세, 수정에서 온 경우
	...
	document.getElementById('frm_pub').action='repcseFrame.php';
...
<div class="con" style="margin-top: 20px">
                ...
                <h1 class="h1_title"><?php echo MyDB::getInstance()->GetMenuByObjId($ProgramID = 'repCcse', $ObjId = 'title'); ?></h1>
                  ...
                  <div class="dataArea">	
	                	<table class="data">
	                        ...
	                        <tbody>
	                            ...
	                            <tr>
	                                <th scope="row"><?php echo MyDB::getInstance()->GetMenuByObjId($ProgramID = 'exms_leftMenu', $ObjId = 'menu_depth1_1'); ?></th>
	                                <td class="period">
                                    <select name="jumpMenu" id="jumpMenu" onChange="MM_jumpMenu('parent',this,0)">
	                                  <option value="repcse.php" <?php if (!(strcmp("", $_GET['value']))) {echo "selected=\"selected\"";} ?>>All...</option>
	                                  <option value="repcse.php?value=0" <?php if (!(strcmp(0, $_GET['value']))) {echo "selected=\"selected\"";} ?>>Par REGION</option>
	                                  <option value="repcse.php?value=142" <?php if (!(strcmp(142, $_GET['value']))) {echo "selected=\"selected\"";} ?>>Rep MINMAP</option>
	                                  <option value="repcse.php?value=144" <?php if (!(strcmp(144, $_GET['value']))) {echo "selected=\"selected\"";} ?>>Rep MINFI</option>
	                                  <option value="repcse.php?value=145" <?php if (!(strcmp(145, $_GET['value']))) {echo "selected=\"selected\"";} ?>>Rep MINEPAT</option>
	                                  <option value="repcse.php?value=143" <?php if (!(strcmp(143, $_GET['value']))) {echo "selected=\"selected\"";} ?>>Rep MINDEVEL</option>
	                                  <option value="repcse.php?value=146" <?php if (!(strcmp(146, $_GET['value']))) {echo "selected=\"selected\"";} ?>>Rep TUTELLE</option>
	                                  <option value="repcse.php?value=40" <?php if (!(strcmp(40, $_GET['value']))) {echo "selected=\"selected\"";} ?>>Rep MO</option>
	                                  <option value="repcse.php?value=2" <?php if (!(strcmp(2, $_GET['value']))) {echo "selected=\"selected\"";} ?>>SECRETAIRE</option>
	                                  <option value="repcse.php?value=1" <?php if (!(strcmp(1, $_GET['value']))) {echo "selected=\"selected\"";} ?>>PRESIDENT</option>
                                    </select></td>
	                            </tr>
                                <?php if (isset($_GET['value']) && ($_GET['value']==0)){ ?>
	                            <tr>
	                                <th scope="row"><?php echo MyDB::getInstance()->GetMenuByObjId($ProgramID = 'exms_leftMenu', $ObjId = 'menu_depth1_1'); ?></th><!-- 개찰일자 -->
	                                <td class="period">
                                    <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
	                                  <option value="repcse.php" <?php if (!(strcmp("repcse.php", $_GET['regID']))) {echo "selected=\"selected\"";} ?>>Select::</option>
	                                  <?php
		do {  
		?>
	                                  <option value="<?php echo "repcse.php?value=".$_GET['value']."&regID=".$row_rsRegion['region_id']?>"<?php if (!(strcmp($row_rsRegion['region_id'], $_GET['regID']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsRegion['region_lib']?></option>
	                                  <?php
		...
		?>
                                ...
                                <tr>
	                                <th scope="row"><?php echo MyDB::getInstance()->GetMenuByObjId($ProgramID = 'exms_leftMenu', $ObjId = 'menu_depth1_1'); ?></th><!-- 개찰일자 -->
	                                <td class="period"><span class="style5">
	                                  <select name="menu2"  onChange="MM_jumpMenu('parent',this,0)">
	                                    <option value="repcse.php" <?php if (!(strcmp("repcse.php", "depID"))) {echo "selected=\"selected\"";} ?>>Select::</option>
	                                    <?php do {  ?>
	                                    <option value="<?php echo "repcse.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$row_rsDepartements['departement_id']?>"<?php if (!(strcmp($row_rsDepartements['departement_id'], $_REQUEST["depID"]))) {echo "selected=\"selected\"";} ?>><?php echo strtoupper($row_rsDepartements['departement_lib']) ?></option>
	                                    <?php
			...
			?>
                                ...
                                <tr>
	                                <th scope="row"><?php echo MyDB::getInstance()->GetMenuByObjId($ProgramID = 'exms_leftMenu', $ObjId = 'menu_depth1_1'); ?></th><!-- 개찰일자 -->
	                                <td class="period"><select name="jumpMenu2" id="jumpMenu2" onChange="MM_jumpMenu('parent',this,0)">
	                                  <option value="<?php echo "repcse.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=" ?>" 
			<?php if (!(strcmp("", $_GET['typeM']))) {echo "selected=\"selected\"";} ?>>[Tous]</option>
	                                  <option value="<?php echo "repcse.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=2" ?>" 
			<?php if (!(strcmp(2, $_GET['typM']))) {echo "selected=\"selected\"";} ?>>SECRETAIRE</option>
	                                  <option value="<?php echo "repcse.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=1" ?>" 
			<?php if (!(strcmp(1, $_GET['typM']))) {echo "selected=\"selected\"";} ?>>PRESIDENT</option>
	                                  <option value="<?php echo "repcse.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=142" ?>" 
			<?php if (!(strcmp(142, $_GET['typM']))) {echo "selected=\"selected\"";} ?>>Rep MINMAP</option>
	                                  <option value="<?php echo "repcse.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=144" ?>" 
			<?php if (!(strcmp(144, $_GET['typM']))) {echo "selected=\"selected\"";} ?>>Rep MINFI</option>
	                                  <option value="<?php echo "repcse.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=145" ?>" 
			<?php if (!(strcmp(145, $_GET['typM']))) {echo "selected=\"selected\"";} ?>>Rep MINEPAT</option>
	                                  <option value="<?php echo "repcse.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=143" ?>" 
			<?php if (!(strcmp(143, $_GET['typM']))) {echo "selected=\"selected\"";} ?>>Rep MINDEVEL</option>
	                                  <option value="<?php echo "repcse.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=146" ?>" 
			<?php if (!(strcmp(146, $_GET['typM']))) {echo "selected=\"selected\"";} ?>>Rep TUTELLE</option>
	                                  <option value="<?php echo "repcse.php?value=".$_GET['value']."&regID=".$_GET['regID']."&depID=".$_GET['depID']."&typM=40"  ?>"
				        ...
				        <?php } ?>
                                ...
                                <tr>
                                    ...
                                    <select name="jumpMenu3" id="jumpMenu3" onChange="MM_jumpMenu('parent',this,0)">
	                                  ...
	                                  <option value="<?php echo "repcse.php?value=" . $_GET['value'] . "&typID=1" ?>" <?php if (!(strcmp(1, $_GET['typID']))) {echo "selected=\"selected\"";} ?>>Commission centrale</option>
	                                  <option value="<?php echo "repcse.php?value=" . $_GET['value'] . "&typID=7" ?>" <?php if (!(strcmp(7, $_GET['typID']))) {echo "selected=\"selected\"";} ?>>Commission Interne</option>
	                                  <option value="<?php echo "repcse.php?value=" . $_GET['value'] . "&typID=8" ?>" <?php if (!(strcmp(8, $_GET['typID']))) {echo "selected=\"selected\"";} ?>>Commission Speciales</option>
	                                  <option value="<?php echo "repcse.php?value=" . $_GET['value'] . "&typID=3" ?>" <?php if (!(strcmp(3, $_GET['typID']))) {echo "selected=\"selected\"";} ?>>Commission régionale</option>
	                                  <option value="<?php echo "repcse.php?value=" . $_GET['value'] . "&typID=4" ?>" <?php if (!(strcmp(4, $_GET['typID']))) {echo "selected=\"selected\"";} ?>>Commission départementale</option>
	                                  <option value="<?php echo "repcse.php?value=" . $_GET['value'] . "&typID=10" ?>" <?php if (!(strcmp(10, $_GET['typID']))) {echo "selected=\"selected\"";} ?>>Cadre de concertation</option>
                                    </select></td>
	                            </tr>
                                <?php if (isset($_GET['typID']) && ($_GET['typID']==3 || $_GET['typID']==4 || $_GET['typID']==7)){ ?>
                                <tr>
	                                <th scope="row"><?php echo MyDB::getInstance()->GetMenuByObjId($ProgramID = 'exms_leftMenu', $ObjId = 'menu_depth1_1'); ?></th><!-- 개찰일자 -->
	                                <td class="period"><select name="menu3" onChange="MM_jumpMenu('parent',this,0)">
	                                  <option value="repcipm.php" <?php if (!(strcmp("repcipm.php", $_GET['regID']))) {echo "selected=\"selected\"";} ?>>Select::</option>
	                                  <?php
		do {  
		?>
	                                  <option value="<?php echo "repcse.php?value=".$_GET['value']."&typID=".$coltypID_fonction."&regID=".$row_rsRegion['region_id']?>"<?php if (!(strcmp($row_rsRegion['region_id'], $_GET['regID']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsRegion['region_lib']?></option>
	                                  <?php
		} while ($row_rsRegion = mysql_fetch_assoc($rsRegion));
		  $rows = mysql_num_rows($rsRegion);
		  if($rows > 0) {
                                ...
                                <tr>
	                                ...
	                                <td class="period"><span class="style5">
	                                  <select name="menu4"  onChange="MM_jumpMenu('parent',this,0)">
	                                    ...
	                                    <?php do {  ?>
	                                    <option value="<?php echo "repcse.php?value=".$_GET['value']."&typID=".$coltypID_fonction."&regID=".$_GET['regID']."&depID=".$row_rsDepartements['departement_id']?>"<?php if (!(strcmp($row_rsDepartements['departement_id'], $_REQUEST["depID"]))) {echo "selected=\"selected\"";} ?>><?php echo strtoupper($row_rsDepartements['departement_lib']) ?></option>
	                                    <?php
			} while ($row_rsDepartements = mysql_fetch_assoc($rsDepartements));
			  $rows = mysql_num_rows($rsDepartements);
			  if($rows > 0) {
